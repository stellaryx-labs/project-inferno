...
# START TIME
START_TIME = "2023-01-01T00:00:00Z"  # ISO 8601 format (YYYY-MM-DD HH:mm:ss)

# END TIME
END_TIME = "2023-12-31T23:59:59Z"  # ISO 8601 format
...
PALISADES_GEOJSON_PATH = ROOT_DIR / "datasets" / \
